...
export interface InputPhoneProps extends ComponentProps<typeof RPNInput.default> {
	label?: string;
	required?: boolean;
	error?: string;
}

export function InputPhone({ label, required, error, ...props }: InputPhoneProps) {
	return (
		<div className="*:not-first:mt-2" dir="ltr">
			...
			<RPNInput.default
				className={cn('flex rounded-md shadow-xs', error && 'border border-destructive')}
				international
