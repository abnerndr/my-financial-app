...
const createImage = (url: string): Promise<HTMLImageElement> =>
	new Promise((resolve, reject) => {
		const image =
			typeof window !== 'undefined' ? new window.Image() : document.createElement('img');
...
export interface AvatarUploadDroppableCropperProps {
	onGetCroppedImage?: (blob: Blob | null) => void; // Optional callback to get the cropped image blob
}

export function AvatarUploadDroppableCropper({
	onGetCroppedImage,
